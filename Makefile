...
GENERATED_LINKS=alt-ergo www fm-simplex-plugin.cma fm-simplex-plugin.cmxs
...
js:
	$(DUNE) build @install
	ln -sf _build/install/default/share/alt-ergo-js www
...
.PHONY: lib bin fm-simplex plugins js all
...
packages:
	$(DUNE) build $(DUNE_FLAGS) --release @install
